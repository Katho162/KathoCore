...
Configuration
=================
The plugin supports multi-language configuration. if you want to change the plugin messages or maybe implement a new language you can change it in `config.json` file in the plugin folder:
```json
{
  "authentication": {
...
After that the plugin will make a new player account file in `accounts/player-uuid.json`
